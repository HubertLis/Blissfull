defmodule BlissfullySewnWeb.CategoryLive.Index do
  use BlissfullySewnWeb, :live_view

  alias BlissfullySewn.Categories
  alias BlissfullySewn.Categories.Category
  ...
  @impl true
  def handle_info({BlissfullySewnWeb.CategoryLive.FormComponent, {:saved, category}}, socket) do
